...
function Hero() {
    return ( 
        <div className="container p-5">
                <h1 className='text-center'>We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h1>
            <div className="row border-top mt-5">
                <div className="col mt-5 p-5" style={{lineHeight: '2.0', fontSize: '1rem'}}>
